...
var _user$project$Content_Blogg_Refactor$content = A2(
	...
	_user$project$Content_Blogg_Refactor$about);

var _user$project$Commands$viewHeaderCommands = A2(
		...
		_0: A2(
			_elm_lang$html$Html$a,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Types$ClickCommand('about')),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Me'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$a,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Types$ClickCommand('about page')),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Types$ClickCommand('blog')),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Types$ClickCommand('help')),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Commands$viewCommand = function (command) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$a,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Types$ClickCommand(command)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Commands$NotValid = function (a) {
	return {ctor: 'NotValid', _0: a};
};
var _user$project$Commands$NewPrompt = {ctor: 'NewPrompt'};
var _user$project$Commands$Clear = {ctor: 'Clear'};
var _user$project$Commands$Blog = {ctor: 'Blog'};
var _user$project$Commands$Help = {ctor: 'Help'};
var _user$project$Commands$GitHub = {ctor: 'GitHub'};
var _user$project$Commands$About = function (a) {
	return {ctor: 'About', _0: a};
};
var _user$project$Commands$Page = {ctor: 'Page'};
var _user$project$Commands$Me = {ctor: 'Me'};
var _user$project$Commands$availableCommands = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: {ctor: '[]'},
			_1: _user$project$Commands$NewPrompt
		},
		_1: {
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					...
					_1: _user$project$Commands$About(
						_elm_lang$core$Maybe$Just(_user$project$Commands$Me))
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _user$project$Commands$About(
							_elm_lang$core$Maybe$Just(_user$project$Commands$Page))
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: _user$project$Commands$Blog
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_1: _user$project$Commands$Help
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: _user$project$Commands$GitHub
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: _user$project$Commands$Clear
									},
									_1: {ctor: '[]'}
								}
							}
...
var _user$project$Commands$parseCommand = function (rawCommand) {
	var command = _elm_lang$core$String$words(
		_elm_lang$core$String$toLower(
			_elm_lang$core$String$trim(rawCommand)));
	var _p0 = A2(_elm_lang$core$Dict$get, command, _user$project$Commands$availableCommands);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return _user$project$Commands$NotValid(
			A2(_elm_lang$core$String$join, ' ', command));
	}
};
var _user$project$Commands$viewHelp = function () {
	var commands = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$String$join(' '),
		A2(
			...
			function (xs) {
				return !(_elm_lang$core$List$isEmpty(xs) || _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$List$head(xs),
					_elm_lang$core$Maybe$Just('')));
			},
			_elm_lang$core$Dict$keys(_user$project$Commands$availableCommands)));
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Available commands:'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$p,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Commands$viewCommand, commands)),
				_1: {ctor: '[]'}
			}
		});
}();
var _user$project$Commands$ClearHistory = {ctor: 'ClearHistory'};
var _user$project$Commands$Content = function (a) {
	return {ctor: 'Content', _0: a};
};
var _user$project$Commands$runCommand = function (rawCommand) {
	var _p1 = _user$project$Commands$parseCommand(rawCommand);
	switch (_p1.ctor) {
		case 'NewPrompt':
			return _user$project$Commands$Content(
				_elm_lang$html$Html$text(''));
		case 'About':
			var _p2 = _p1._0;
			if (_p2.ctor === 'Just') {
				if (_p2._0.ctor === 'Me') {
					return _user$project$Commands$Content(_user$project$Content_Me$content);
				} else {
					return _user$project$Commands$Content(_user$project$Content_Page$content);
				}
			} else {
				return _user$project$Commands$Content(
					_elm_lang$html$Html$text('Do you want \'me\' or \'page\'?'));
			}
		case 'Blog':
			return _user$project$Commands$Content(_user$project$Content_Blogg_Refactor$content);
		case 'GitHub':
			return _user$project$Commands$Content(
				A2(
					_evancz$elm_markdown$Markdown$toHtml,
					{ctor: '[]'},
					'My github is @: [https://github.com/litemerafrukt](https://github.com/litemerafrukt)'));
		case 'Help':
			return _user$project$Commands$Content(_user$project$Commands$viewHelp);
		case 'Clear':
			return _user$project$Commands$ClearHistory;
		default:
			return _user$project$Commands$Content(
				_elm_lang$html$Html$text(
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], _p1._0, '\'. Please try \'help\'.'))));
	}
};

var _user$project$App$onEnter = function (msg) {
...
var _user$project$App$viewHistorySection = function (historySection) {
	return A2(
		_elm_lang$html$Html$section,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('history-section'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$App$viewHistory = function (outputHistory) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$App$viewHistorySection, outputHistory));
};
var _user$project$App$promptSymboml = A2(
...
var _user$project$App$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('screen'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('**** LITEMINDREGUI 64 BASIC V2 ****'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('header-text header-links'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$Commands$viewHeaderCommands,
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$App$viewHistory, model.outputHistory),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$App$promptSymboml,
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('inputoutput'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.prompt),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('theprompt'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$type_('text'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(model.prompt),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$PromptOutput),
																	_1: {
																		ctor: '::',
																		_0: _user$project$App$onEnter(_user$project$Types$CliCommand),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onBlur(_user$project$Types$PromptFocus),
																			_1: {ctor: '[]'}
																		}
																	}
																}
		...
		while (true) {
			...
			switch (_p0.ctor) {
				...
				case 'CliCommand':
					...
					var _p1 = _user$project$Commands$runCommand(model.prompt);
					if (_p1.ctor === 'Content') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								...
								}),
							{
								...
								_0: A2(
									...
									_elm_lang$dom$Dom_Scroll$toBottom('screen')),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
				...
				case 'ClickCommand':
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{prompt: _p0._0});
					var _v2 = _user$project$Types$CliCommand,
						_v3 = newModel;
					msg = _v2;
					model = _v3;
					continue update;
					...
					return A2(
						...
						model,
						{
							...
							_0: A2(
								_elm_lang$core$Task$attempt,
								_elm_lang$core$Basics$always(_user$project$Types$NoOp),
								_elm_lang$dom$Dom$focus('theprompt')),
							_1: {ctor: '[]'}
						});
				default:
					return A2(
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{view: _user$project$App$view, init: _user$project$App$init, update: _user$project$App$update, subscriptions: _user$project$Main$subscriptions})();
